...
public:
	...
	//const char *NameForValue( INDEX iValue );
};
...
public:
	...
	CEntityComponent( EntityComponentType ectType,
		...
		: ec_ectType( ectType )
		, ec_slID( ulID )
		, ec_fnmComponent( strEFNMComponent, 4 )
	{
		ec_pvPointer = NULL;
	};
...
public:
	...
	CEntityProperty *PropertyForTypeAndID( CEntityProperty::PropertyType eptType, ULONG ulID );
