...
inline FLOAT SinFast( ANGLE a ) { return (FLOAT) sin( a*(PI / ANGLE_180) ); };
inline FLOAT CosFast( ANGLE a ) { return (FLOAT) cos( a*(PI / ANGLE_180) ); };
inline FLOAT TanFast( ANGLE a ) { return (FLOAT) tan( a*(PI / ANGLE_180) ); };
