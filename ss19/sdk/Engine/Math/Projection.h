...
// interface:
  ...
  /* Default constructor. */
	...
	void Prepare( void )
	{
		using fnPrepare = void( __thiscall* )(void* pThis);
		static fnPrepare fpPrepare;
		fpPrepare = (fnPrepare) ((*(void***) this)[0]);
		if ( fpPrepare )
			fpPrepare( this );
	}
	BOOL IsPerspective( void )
	{
		using fnIsPerspective = BOOL( __thiscall* )(void* pThis);
		static fnIsPerspective fpIsPerspective;
		fpIsPerspective = (fnIsPerspective) ((*(void***) this)[1]);
		if ( fpIsPerspective )
			return fpIsPerspective( this );
		return FALSE;
	}

	///* Project 3D object point into 3D view space. */
	void ProjectCoordinate( const FLOAT3D &v3dObjectPoint, FLOAT3D &v3dViewPoint )
	{
		using fnProjectCoordinate = void( __thiscall* )(void* pThis, const FLOAT3D &v3dObjectPoint, FLOAT3D &v3dViewPoint);
		static fnProjectCoordinate fpProjectCoordinate;
		fpProjectCoordinate = (fnProjectCoordinate) ((*(void***) this)[2]);
		if ( fpProjectCoordinate )
			fpProjectCoordinate( this, v3dObjectPoint, v3dViewPoint );
	}
 ...
 */
class CPerspectiveProjection3D : public CProjection3D {
public:
// implementation:
  // factors set by user
 ...
 */
class CIsometricProjection3D : public CProjection3D {
public:
 ...
 * Isometric projection.
 */
class CParallelProjection3D : public CProjection3D {
public:
// implementation:
  // factors set by user
 ...
 * Simple projection.
 */
class CSimpleProjection3D : public CProjection3D {
public:
// implementation:
  // factors set by user
  // internal variables
 ...
 * Reference viewer placement.
 */
inline CPlacement3D &CProjection3D::ViewerPlacementL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_ViewerPlacement;
}
inline const CPlacement3D &CProjection3D::ViewerPlacementR( void ) const
{
	return pr_ViewerPlacement;
}
 ...
 * Reference object placement.
 */
inline CPlacement3D &CProjection3D::ObjectPlacementL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_ObjectPlacement;
}
inline const CPlacement3D &CProjection3D::ObjectPlacementR( void ) const
{
	return pr_ObjectPlacement;
}

/* Reference object handle. */
inline FLOAT3D &CProjection3D::ObjectHandleL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_vObjectHandle;
}
inline const FLOAT3D &CProjection3D::ObjectHandleR( void ) const
{
	return pr_vObjectHandle;
}
 ...
 */
inline FLOAT &CProjection3D::FrontClipDistanceL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_NearClipDistance;
}
inline const FLOAT &CProjection3D::FrontClipDistanceR( void ) const
{
	return pr_NearClipDistance;
}
inline FLOAT &CProjection3D::NearClipDistanceL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_NearClipDistance;
}
inline const FLOAT &CProjection3D::NearClipDistanceR( void ) const
{
	return pr_NearClipDistance;
}
inline FLOAT &CProjection3D::FarClipDistanceL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_FarClipDistance;
}
inline const FLOAT &CProjection3D::FarClipDistanceR( void ) const
{
	return pr_FarClipDistance;
}
 ...
 * Reference screen bounding box.
 */
inline FLOATaabbox2D &CProjection3D::ScreenBBoxL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_ScreenBBox;
}
inline const FLOATaabbox2D &CProjection3D::ScreenBBoxR( void ) const
{
	return pr_ScreenBBox;
}
 ...
 * Reference screen aspect ratio.
 */
inline FLOAT &CProjection3D::AspectRatioL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_AspectRatio;
}
inline const FLOAT &CProjection3D::AspectRatioR( void ) const
{
	return pr_AspectRatio;
}

/* Reference target object stretching. */
inline FLOAT3D &CProjection3D::ObjectStretchL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_ObjectStretch;
}
inline const FLOAT3D &CProjection3D::ObjectStretchR( void ) const
{
	return pr_ObjectStretch;
}

/* Reference view stretching. */
inline FLOAT &CProjection3D::ViewStretchL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_fViewStretch;
}
inline const FLOAT &CProjection3D::ViewStretchR( void ) const
{
	return pr_fViewStretch;
}

/* Reference mirror plane. */
inline FLOATplane3D &CProjection3D::MirrorPlaneL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	pr_bMirror = TRUE;
	return pr_plMirror;
}
inline const FLOATplane3D &CProjection3D::MirrorPlaneR( void ) const
{
	return pr_plMirror;
}
...
/* Reference warp plane. */
inline FLOATplane3D &CProjection3D::WarpPlaneL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	pr_bWarp = TRUE;
	return pr_plMirror;
}
inline const FLOATplane3D &CProjection3D::WarpPlaneR( void ) const
{
	return pr_plMirror;
}
 ...
 */
inline BOOL &CProjection3D::ObjectFaceForwardL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_bFaceForward;
}
inline const BOOL &CProjection3D::ObjectFaceForwardR( void ) const
{
	return pr_bFaceForward;
}
inline BOOL &CProjection3D::ObjectHalfFaceForwardL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_bHalfFaceForward;
}
inline const BOOL &CProjection3D::ObjectHalfFaceForwardR( void ) const
{
	return pr_bHalfFaceForward;
}

/* Reference corrections for depth buffer factor. */
inline FLOAT &CProjection3D::DepthBufferNearL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_fDepthBufferNear;
}
inline const FLOAT &CProjection3D::DepthBufferNearR( void ) const
{
	return pr_fDepthBufferNear;
}
inline FLOAT &CProjection3D::DepthBufferFarL( void )
{
	//IFDEBUG( pr_Prepared = FALSE );    // invalidate precalculations on any non-const access
	return pr_fDepthBufferFar;
}
inline const FLOAT &CProjection3D::DepthBufferFarR( void ) const
{
	return pr_fDepthBufferFar;
}
 ...
 * Start beeing CSimpleProjection3D.
 */
inline void CAnyProjection3D::BeSimple( void )
{
 ...
 * Start beeing CIsometricProjection3D.
 */
inline void CAnyProjection3D::BeIsometric( void )
{
 ...
 * Start beeing CPerspectiveProjection3D.
 */
inline void CAnyProjection3D::BePerspective( void )
{
 ...
 * Start beeing CParallelProjection3D.
 */
inline void CAnyProjection3D::BeParallel( void )
{
	ap_CurrentProjection = &ap_Parallel;
}

/* Test if CSimpleProjection3D. */
inline BOOL CAnyProjection3D::IsSimple( void )
{
	return ap_CurrentProjection == &ap_Simple;
}
/* Test if CIsometricProjection3D. */
inline BOOL CAnyProjection3D::IsIsometric( void )
{
	return ap_CurrentProjection == &ap_Isometric;
}
/* Test if CPerspectiveProjection3D. */
inline BOOL CAnyProjection3D::IsPerspective( void )
{
	return ap_CurrentProjection == &ap_Perspective;
}
/* Test if CParallelProjection3D. */
inline BOOL CAnyProjection3D::IsParallel( void )
{
 ...
 * Reference currently active projection.
 */
inline CProjection3D *CAnyProjection3D::operator->( void )
{
 ...
 * Get the pointer to currently active projection.
 */
inline CAnyProjection3D::operator CProjection3D *(void)
{
	return ap_CurrentProjection;
}
 ...
 * Initialize from another any-projection.
 */
inline void CAnyProjection3D::operator=( const CAnyProjection3D &prAny )
{
 ...
 * Initialize from a simple projection.
 */
inline void CAnyProjection3D::operator=( const CSimpleProjection3D &prSimple )
{
	ap_Simple = prSimple;
	ap_CurrentProjection = &ap_Simple;
}
 ...
 * Initialize from an isometric projection.
 */
inline void CAnyProjection3D::operator=( const CIsometricProjection3D &prIsometric )
{
 ...
 * Initialize from a perspective projection.
 */
inline void CAnyProjection3D::operator=( const CPerspectiveProjection3D &prPerspective )
{
 ...
 * Initialize from a parallel projection.
 */
inline void CAnyProjection3D::operator=( const CParallelProjection3D &prParallel )
{
